...
**Blog App** is a Ryby on Rails project
...
1. Clone this project on your local machine using the following command on your Git Bash: `git clone https://github.com/ouasamine/rails-blog`

2. Browse to project directory `cd rails-blog`
